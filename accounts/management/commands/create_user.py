...
ENV_ROOT = Path(__file__).resolve().parents[3]  # project root guess
        ...
        **extra_fields,
        ...
        if qs.exists():
            ...
            if update_existing:
                ...
                self.stdout.write(
                    self.style.WARNING(
                        f"User '{username}' already exists. (use --update-existing to modify)"  # noqa: E501
                    )
                )
            ...
            # If you have required fields in a custom user, set them here via extra_fields # noqa: E501
